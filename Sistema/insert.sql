...
INSERT INTO `comida_2`(`id_comida`, `tipo`, `descripcion`) VALUES (7,2,'Ensalada de tomate y lechuga');
...
(1234567891, 'Luis', 'Martinez', 'El paraiso', 'luismartinez@gmail.com',02121234567891,02121234567892,04241234567891, 'abogado', 'soltero', 1, 'S'),
(1234567892, 'Luifer', 'Martinez', 'El paraiso', 'luifermartinez@gmail.com',02121234567892,02121234567893,04241234567892, 'ingeniero', 'casado', 1, 'S'),
(1234567893, 'Luisa', 'Morales', 'Montalban', 'luisita@gmail.com',02121234567893,02121234567894,04241234567893, 'fotografo', 'soltero', 1, 'S'),
(1234567894, 'Maria', 'Perez', 'El valle', 'maria@gmail.com',02121234567894,02121234567895,04241234567894, 'bombero', 'soltero', 1, 'N'),
(1234567895, 'Jessica', 'Medina', 'La lagunita', 'jessicam@hotmail.com',02121234567895,02121234567896,04241234567895, 'modelo', 'soltero', 1, 'S'),
(1234567896, 'Iris', 'Ilarraza', 'La lagunita', 'irisfashion@hotmail.com',02121234567896,02121234567897,04241234567896, 'medico', 'soltero', 1, 'N'),
(1234567897, 'Fatima', 'Goncalves', 'La lagunita', 'fatimag@hotmail.com',02121234567897,02121234567898,04241234567897, 'profesor', 'casado', 1, 'N'),
(1234567898, 'Ramon', 'Medina', 'La lagunita', 'ramonmedina@hotmail.com',02121234567898,02121234567899,04241234567898, 'abogado', 'soltero', 1, 'S'),
(1234567899, 'Fernando', 'Gomes', 'La Bandera', 'fernandog@yahoo.com',02121234567899,02121234567896,04241234567899, 'odontologo', 'soltero', 1, 'N'),
(1234567881, 'Alexander', 'De Azevedo', 'el paraiso', 'jmedina@hotmail.com',02121234567881,02121234567882,04241234567881, 'fotografo', 'soltero', 1, 'S'),
(1234567882, 'Sergio', 'Medina', 'Catia', 'sagg305@hotmail.com',02121234567882,02121234567882,04241234567882, 'futbolista', 'casado', 1, 'N'),
...
(1, 1, 1234567861, 'Alexander', 'De Azevedo', 'el paraiso', 04241234567, 'universitario', 1500000),
(2, 1, 1234567862, 'Brayan', 'Gomes','la vega', 04241234568, 'tsu', 1000000),
(3, 1, 1234567863, 'Carlos', 'Perez', 'la tahona', 04241234569, 'bachillerato', 900000),
(4, 1,1234567864, 'Fatima', 'Maduro', 'petare', 04241234560, 'tsu', 1100000),
(5, 1,  1234567865, 'Fabiana', 'Puglisi', 'catia', 04241234561, 'bachillerato', 900000),
(6, 2,  1234567866, 'Alexander', 'De Azevedo', 'el paraiso', 04241234567, 'universitario', 1500000),
(7, 2,  1234567867, 'Brayan', 'Gomes','la vega', 04241234577, 'tsu', 1000000),
(8, 2,  1234567868, 'Carlos', 'Perez', 'la tahona', 04241234572, 'bachillerato', 900000),
(9, 2,  1234567869, 'Fatima', 'Maduro', 'petare', 04241234578, 'tsu', 1200000),
(10, 2, 1234567860, 'Fabiana', 'Puglisi', 'catia', 04241234579, 'tsu', 900000),
(11, 3, 1234567851, 'Luis', 'De Azevedo', 'el paraiso', 04241234531, 'bachillerato', 1500000),
(12, 3,  1234567852, 'Brayan', 'Gomes','la vega', 04241234512, 'tsu', 1100000),
(13, 3,  1234567853, 'Carlos', 'Perez', 'la tahona', 04241234535, 'tsu', 900000),
