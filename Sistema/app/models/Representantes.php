    ...
    use DBModel;
        ...
        */
        final private function errors(bool $edit = false) {
          ...
          $this->parentesco = $http->request->get('parentesco');
          ...
          if($this->functions->e($this->profesion)){
            throw new ModelsException('El campo profesion es obligatorio');
          }

          if($this->functions->e($this->sexo)){
            throw new ModelsException('El campo sexo obligatorio');
          }

          if($this->functions->e($this->parentesco)){
            throw new ModelsException('El campo parentesco es obligatorio');
          }
