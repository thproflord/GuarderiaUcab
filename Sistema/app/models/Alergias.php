...
class Alergias extends Models implements IModels {
    /**
    ...
    */
    ...
    final private function errors(bool $edit = false) {
      ...
      $cedula_exist = $this->db->query_select("SELECT * FROM alergia_2 WHERE cedula = '$this->cedula'");
    ...
    final public function add(){
      try {
        ...
        # Insertar elementos
        $this->db->query("INSERT INTO alergia_2
    ...
    */
    final public function edit() : array {
      try {
        ...
        $this->db->query("UPDATE alergia_2
        ...
        */
        final public function delete($id) {
          ...
          $this->db->query("DELETE FROM alergia_2 WHERE cedula = '$id'");
          # Redireccionar a la página principal del controlador
          $this->functions->redir($config['site']['url'] . 'alergias/&success=true');
        }


    final public function get(bool $multi = true, string $select = '*') {
        return $this->db->query_select("SELECT * FROM alergia_2;");
    }
